            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="float-right">
                        <div class="template-button" id="template"><i class="far fa-file-alt"></i></div>
                        <div class="help-button" data-toggle="modal" data-target="#helpModal"><i class="far fa-question-circle"></i></div>
                    </div>
                </div>
